...
const PROTECTED_PAGES = ["/dashboard", "/groups", "/profile", "/balances", "/admin", "/friends", "/direct-expenses", "/personal", "/insights", "/budgets", "/expenses"]
const PROTECTED_API_PREFIXES = ["/api/groups", "/api/dashboard", "/api/uploads", "/api/profile", "/api/expenses", "/api/balances", "/api/direct-settle", "/api/users", "/api/admin", "/api/friends", "/api/friend-requests", "/api/notifications", "/api/budgets", "/api/insights"]
